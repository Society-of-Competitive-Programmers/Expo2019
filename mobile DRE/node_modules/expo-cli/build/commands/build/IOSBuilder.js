  ...
  (0, (_createClass2 || _load_createClass()).default)(IOSBuilder, [{
        ...
        return (_regenerator || _load_regenerator()).default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 21:
                _context.next = 23;
                return this.checkStatus((0, (_extends2 || _load_extends()).default)({ platform: 'ios', sdkVersion: sdkVersion }, buildOptions));
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.t0 = (_extends2 || _load_extends()).default;
                _context2.t1 = {};
                _context2.t2 = creds;
                _context2.next = 6;
              ...
              case 6:
                _context2.t3 = _context2.sent.toString('base64');
                _context2.next = 9;
                return (_fsExtra || _load_fsExtra()).default.readFile(creds.certP12);

              case 9:
                _context2.t4 = _context2.sent.toString('base64');
                _context2.next = 12;
              ...
              case 12:
                ...
                _context2.t6 = {
                  provisioningProfile: _context2.t3,
                  certP12: _context2.t4,
                  pushP12: _context2.t5
                };
    ...
    value: function () {
      var _ref4 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee3() {
        var credentialsToAskFor = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : ['distCert', 'pushCert', 'provisioningProfile'];

        var newCredentials, newMetadata, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, choice, _ref5, metadata, credentials;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 8:
                ...
                choice = _step.value;
                _context3.next = 12;
                return this.userProvidedOverride(choice);
              ...
              case 12:
                ...
                newCredentials = (0, (_extends2 || _load_extends()).default)({}, newCredentials, credentials);
                newMetadata = (0, (_extends2 || _load_extends()).default)({}, newMetadata, metadata);
    ...
    value: function () {
      var _ref6 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee4(choice) {
        var distCertValues, certP12Buffer, certPassword, distCertSerialNumber, pushCertValues, _ref7, pathToProvisioningProfile;
        ...
        return (_regenerator || _load_regenerator()).default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.t0 = choice;
                _context4.next = _context4.t0 === 'distCert' ? 3 : _context4.t0 === 'pushCert' ? 13 : _context4.t0 === 'provisioningProfile' ? 26 : 39;
                break;
              ...
              case 9:
                ...
                distCertSerialNumber = (_xdl || _load_xdl()).IosCodeSigning.findP12CertSerialNumber(certP12Buffer, certPassword);
              ...
              case 21:
                ...
                _context4.t6 = _context4.t2._ensureObjectsHasOnlyStrings.call(_context4.t2, _context4.t5);
                return _context4.abrupt('return', {
                  metadata: _context4.t1,
                  credentials: _context4.t6
                });
              ...
              case 29:
                ...
                pathToProvisioningProfile = _ref7.pathToProvisioningProfile;
                _context4.t7 = {};
                _context4.t8 = this;
                _context4.next = 35;
              ...
              case 35:
                _context4.t9 = _context4.sent.toString('base64');
                _context4.t10 = {
                  provisioningProfile: _context4.t9
                };
                _context4.t11 = _context4.t8._ensureObjectsHasOnlyStrings.call(_context4.t8, _context4.t10);
                return _context4.abrupt('return', {
                  metadata: _context4.t7,
                  credentials: _context4.t11
                });
      ...
      function userProvidedOverride(_x2) {
    ...
    key: '_ensureObjectsHasOnlyStrings',
    value: function _ensureObjectsHasOnlyStrings(obj) {
      var result = {};
      (0, (_keys || _load_keys()).default)(obj).forEach(function (k) {
        var isString = typeof obj[k] === 'string';
        if (isString) {
          result[k] = obj[k];
        } else {
          result[k] = (0, (_stringify || _load_stringify()).default)(obj[k]);
        }
      });
      return result;
    }
    ...
    value: function () {
      var _ref8 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee5(appleCreds, credsMetadata, teamId) {
        var checkAppExistenceAttempt, _checkAppExistenceAtt, result, other;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 7:
                ...
                _checkAppExistenceAtt = checkAppExistenceAttempt, result = _checkAppExistenceAtt.result, other = (0, (_objectWithoutProperties2 || _load_objectWithoutProperties()).default)(_checkAppExistenceAtt, ['result']);
                return _context5.abrupt('return', this._ensureObjectsHasOnlyStrings(other));
      ...
      function _ensureAppExists(_x3, _x4, _x5) {
    ...
    value: function () {
      var _ref9 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee6(appleCreds, credsMetadata, teamId, isEnterprise) {
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 2:
                ...
                return _context6.abrupt('return', this._ensureObjectsHasOnlyStrings(produceProvisionProfileAttempt));
      ...
      function produceProvisionProfile(_x6, _x7, _x8, _x9) {
    ...
    value: function () {
      var _ref10 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee7(choice, appleCreds, teamId, credsMetadata, isEnterprise) {
        var produceCertAttempt, distCertSerialNumber, producePushCertsAttempt;
        return (_regenerator || _load_regenerator()).default.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _context7.t0 = choice;
                _context7.next = _context7.t0 === 'distCert' ? 3 : _context7.t0 === 'pushCert' ? 9 : _context7.t0 === 'provisioningProfile' ? 14 : 19;
                break;
              ...
              case 5:
                ...
                distCertSerialNumber = (_xdl || _load_xdl()).IosCodeSigning.findP12CertSerialNumber(produceCertAttempt.certP12, produceCertAttempt.certPassword);
                return _context7.abrupt('return', {
                  metadata: {
                    distCertSerialNumber: distCertSerialNumber
                  },
              ...
              case 14:
                _context7.t1 = {};
                _context7.next = 17;
                return this.produceProvisionProfile(appleCreds, credsMetadata, teamId, isEnterprise);

              case 17:
                _context7.t2 = _context7.sent;
                return _context7.abrupt('return', {
                  metadata: _context7.t1,
                  credentials: _context7.t2
                });
      ...
      function expoManagedResource(_x10, _x11, _x12, _x13, _x14) {
    ...
    key: '_revokeHelper',
    value: function () {
      var _ref11 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee8(appleCredentials, credsMetadata, teamId, isEnterprise, distOrPush) {
      ...
      function _revokeHelper(_x15, _x16, _x17, _x18, _x19) {
    ...
    key: '_handleRevokes',
    value: function () {
      var _ref12 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee9(appleCredentials, credsMetadata, teamId, isEnterprise) {
        var f, revokeAttempt;
      ...
      function _handleRevokes(_x20, _x21, _x22, _x23) {
    ...
    value: function () {
      var _ref13 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee10(credsMetadata, justTeamId, isEnterprise) {
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 6:
                ...
                _context10.next = 10;
                return this._handleRevokes(appleCredentials, credsMetadata, checkCredsAttempt.teamId, isEnterprise);

              case 10:
                _context10.next = 12;
                return this._ensureAppExists(appleCredentials, credsMetadata, checkCredsAttempt.teamId);
      ...
      function _validateCredsEnsureAppExists(_x24, _x25, _x26) {
    ...
    value: function () {
      var _ref14 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee11(appleCredentials, teamId, credsMetadata, isEnterprise) {
        var credsMissing = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : ['distCert', 'pushCert', 'provisioningProfile'];

        var whatToOverrideFiltered, whatToOverrideResult, expoManages, _ref16, userCredentialId, serialNumber, toCopy, newCredentials, newMetadata, spinner, choices, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, choice, _ref17, metadata, credentials, _ref18, _metadata, _credentials;
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                ...
                whatToOverrideFiltered = whatToOverride.filter(function (_ref15) {
              ...
              case 4:
                ...
                _context11.next = 9;
                return this._chooseDistCert(credsMetadata.username, teamId);
              ...
              case 13:
                _ref16 = _context11.t0;
                userCredentialId = _ref16.userCredentialId;
                serialNumber = _ref16.serialNumber;
                ...
                newCredentials = {};
                newMetadata = (0, (_extends2 || _load_extends()).default)({}, credsMetadata);
              ...
              case 29:
                ...
                spinner.start();
                _context11.next = 36;
                return this.expoManagedResource(choice, appleCredentials, teamId, newMetadata, isEnterprise);
              ...
              case 46:
                ...
                _metadata = _ref18.metadata;
                _credentials = _ref18.credentials;

                newMetadata = (0, (_extends2 || _load_extends()).default)({}, newMetadata, _metadata);
                newCredentials = (0, (_extends2 || _load_extends()).default)({}, newCredentials, _credentials);
        ...
        }, _callee11, this, [[23, 70, 73, 76], [27, 56, 60, 68], [61,, 63, 67]]);
      }));

      function runningAsExpoManaged(_x27, _x28, _x29, _x30) {
    ...
    key: '_chooseDistCert',
    value: function () {
      var _ref19 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee12(username, teamId) {
        var certs, choices, _ref21, distCert;
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              ...
              case 2:
                ...
                choices = certs.map(function (_ref20) {
                  var userCredentialId = _ref20.userCredentialId,
                      certId = _ref20.certId,
                      serialNumber = _ref20.serialNumber,
                      usedByApps = _ref20.usedByApps;
      ...
      function _chooseDistCert(_x32, _x33) {
    ...
    key: 'runLocalAuth',
    value: function () {
      var _ref22 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee13(credsMetadata) {
        var credsStarter, clientHasAllNeededCreds, credsMissing, credentialsCI, creds, strategy, isEnterprise, _ref23, appleCredentials, team, _ref24, newCredentials, newMetadata, _ref25, _newCredentials, _newMetadata, _credsStarter, result, _creds, withoutEncrypted;
          ...
          while (1) {
            switch (_context13.prev = _context13.next) {
              ...
              case 2:
                ...
                _context13.next = 9;
                return this.runningAsCI();

              case 9:
                credentialsCI = _context13.sent;
                creds = (0, (_extends2 || _load_extends()).default)({}, credsStarter, credentialsCI);
              ...
              case 14:
                (_log || _load_log()).default.warn('Encrypted ' + (0, (_keys || _load_keys()).default)(OBLIGATORY_CREDS_KEYS).join(', ') + ' and saved to expo servers');
                _context13.next = 54;
                break;
              ...
              case 20:
                ...
                _context13.next = 25;
                return this._validateCredsEnsureAppExists(credsMetadata, !strategy.isExpoManaged, isEnterprise);

              case 25:
                _ref23 = _context13.sent;
                appleCredentials = _ref23.appleCredentials;
                team = _ref23.team;

                credsStarter = (0, (_extends2 || _load_extends()).default)({}, credsStarter, team);
                ...
                _context13.next = 32;
                return this.runningAsExpoManaged(appleCredentials, credsStarter.teamId, credsMetadata, isEnterprise, credsMissing);

              case 32:
                _ref24 = _context13.sent;
                newCredentials = _ref24.newCredentials;
                newMetadata = _ref24.newMetadata;

                credsStarter = (0, (_extends2 || _load_extends()).default)({}, credsStarter, newCredentials);
                credsMetadata = (0, (_extends2 || _load_extends()).default)({}, credsMetadata, newMetadata);
                _context13.next = 46;
                break;

              case 39:
                _context13.next = 41;
                return this.runningAsExpert(credsMissing);

              case 41:
                _ref25 = _context13.sent;
                _newCredentials = _ref25.newCredentials;
                _newMetadata = _ref25.newMetadata;

                credsStarter = (0, (_extends2 || _load_extends()).default)({}, credsStarter, _newCredentials);
                credsMetadata = (0, (_extends2 || _load_extends()).default)({}, credsMetadata, _newMetadata);

              case 46:
                _credsStarter = credsStarter, result = _credsStarter.result, _creds = (0, (_objectWithoutProperties2 || _load_objectWithoutProperties()).default)(_credsStarter, ['result']);

                this._areCredsMissing(_creds);

                withoutEncrypted = (_lodash || _load_lodash()).default.pickBy(_creds, function (v) {
                  return v !== 'encrypted';
                });
                _context13.next = 51;
    ...
    value: function _throwIfFailureWithReasonDump(replyAttempt) {
      if (replyAttempt.result === 'failure') {
        ...
        throw new Error('Reason: ' + reason + ', raw: ' + (0, (_stringify || _load_stringify()).default)(rawDump, null, 2));
      }
    }
  }, {
    key: 'askForAppleCreds',
    value: function () {
      var _ref26 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee14() {
        var justTeamId = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
        var appleId, password;
